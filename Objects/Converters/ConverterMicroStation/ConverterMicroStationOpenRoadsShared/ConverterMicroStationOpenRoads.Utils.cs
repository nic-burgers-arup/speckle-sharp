...
namespace Objects.Converter.MicroStationOpenRoads
{
  public partial class ConverterMicroStationOpenRoads
  {
    ...
    public static void SetInstanceStringValue(ref StandaloneECDInstance instance, string propertyName, object obj)
    {
      string value;
      if (obj == null)
      {
      ...
      instance.MemoryBuffer.SetStringValue(propertyName, -1, value);
    }

    public static void SetInstanceBooleanValue(ref StandaloneECDInstance instance, string propertyName, object obj)
    {
      bool value;
      if (obj == null)
      {
      ...
      instance.MemoryBuffer.SetBooleanValue(propertyName, -1, value);
    }

    public static void SetInstanceIntegerValue(ref StandaloneECDInstance instance, string propertyName, object obj)
    {
      int value;
      if (obj == null)
      {
      ...
      instance.MemoryBuffer.SetIntegerValue(propertyName, -1, value);
    }

    public static void SetInstanceDoubleValue(ref StandaloneECDInstance instance, string propertyName, object obj)
    {
      double value;
      if (obj == null)
      {
      ...
      instance.MemoryBuffer.SetDoubleValue(propertyName, -1, value);
    }

    public static void SetInstancePoint3dValue(ref StandaloneECDInstance instance, string propertyName, object obj)
    {
      DPoint3d value;
      if (obj == null)
      {
      ...
      instance.MemoryBuffer.SetPoint3DValue(propertyName, -1, value);
    }
