...
namespace Objects.Converter.MicroStationOpenRoads
{
  public partial class ConverterMicroStationOpenRoads
  {
    ...
    public RevitBeam RevitBeamToSpeckle(Dictionary<string, object> properties, string units = null)
    {
    ...
    public RevitColumn RevitColumnToSpeckle(Dictionary<string, object> properties, string units = null)
    {
    ...
    public Base Type2ElementToSpeckle(Type2Element cellHeader, string units = null)
    {
      ...
      {
        case (Category.Beams):
          element = RevitBeamToSpeckle(properties, u);
          break;

        case (Category.Columns):
        case (Category.Piles):
          element = RevitColumnToSpeckle(properties, u);
          break;
