...
namespace Objects.Structural.ETABS.Properties
{
  public class ETABSSpringProperty: PropertySpring
  {
    ...
    [SchemaInfo("PointSpring (link)", "Create an ETABS PointSpring from Link", "ETABS", "Properties")]
    ...
    [SchemaInfo("PointSpring (soil profile)", "Create an ETABS PointSpring from Soil Profile", "ETABS", "Properties")]
  ...
  public class ETABSAreaSpring : PropertySpring 
  {
    ...
    [SchemaInfo("AreaSpring", "Create an ETABS AreaSpring", "ETABS", "Properties")]
