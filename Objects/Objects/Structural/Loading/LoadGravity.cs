...
namespace Objects.Structural.Loading
{
  public class LoadGravity : Load
  {
    ...
    [SchemaInfo("Gravity Load (all elements)", "Creates a Speckle structural gravity load (applied to all nodes and elements)", "Structural", "Loading")]
    ...
    /// <param name="gravityFactors">A list of factors that apply on the “magnitude" of gravity (in terms of g, accleration of gravity) in each of the global axis (x, y and z) directions. Ex. For a model with global z-axis vertically upwards, the gravity factors of (0, 0, −1) represent a normal vertical gravity load on the structure</param>
    [SchemaInfo("Gravity Load (specified elements)", "Creates a Speckle structural gravity load (applied to specified elements)", "Structural", "Loading")]
    ...
    /// <param name="gravityFactors">A list of factors that apply on the “magnitude" of gravity (in terms of g, accleration of gravity) in each of the global axis (x, y and z) directions. Ex. For a model with global z-axis vertically upwards, the gravity factors of (0, 0, −1) represent a normal vertical gravity load on the structure</param>
    [SchemaInfo("Gravity Load (specified elements and nodes)", "Creates a Speckle structural gravity load (applied to specified nodes and elements)", "Structural", "Loading")]
    public LoadGravity(LoadCase loadCase, List<Base> elements, List<Base> nodes, Vector gravityFactors = null, string name = null)
    {
      this.elements = elements;
      this.nodes = nodes;
      this.loadCase = loadCase;
